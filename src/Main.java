...
public class Main {
    public static ArrayList<Contact> phoneBooks;
    ...
    public static void addNewPhoneBook() {
        ...
        Contact contact=new Contact(tel,group,fullName,gender,address,date,email);
    ...
    public static void updateTel(){
        ...
        String tel= input.nextLine();
        for (int i=0;i<phoneBooks.size();i++){
            if (tel.equals(phoneBooks.get(i).getPhoneNumber())){
                phoneBooks.get(i).setPhoneNumber(tel);
    ...
    public static void updateGroup(){
        ...
        String group= input.nextLine();
        for (int i=0;i<phoneBooks.size();i++){
            if (group.equals(phoneBooks.get(i).getPhoneNumber())){
    ...
    public static void updateName(){
        ...
        for (int i=0;i<phoneBooks.size();i++){
            if (name.equals(phoneBooks.get(i).getPhoneNumber())){
    ...
    public static void updateGender(){
        ...
        String gender= input.nextLine();
        for (int i=0;i<phoneBooks.size();i++){
            if (gender.equals(phoneBooks.get(i).getPhoneNumber())){
    ...
    public static void updateAddress(){
        ...
        String address= input.nextLine();
        for (int i=0;i<phoneBooks.size();i++){
            if (address.equals(phoneBooks.get(i).getPhoneNumber())){
    ...
    public static void savePhoneBook(){
        ...
        try {
            ...
            for (int i=0;i<phoneBooks.size();i++){
                fileWriter.append(phoneBooks.get(i).getPhoneNumber());
